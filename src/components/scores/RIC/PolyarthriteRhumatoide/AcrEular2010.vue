<template>
  <div>
    ...
    <form class="form">
      ...
      <ul class="details">
        On différencie les grosses et petites articulations :
        <li>Grosses articulations : épaule, coude, hanche, genou, cheville.</li>
        <li>Petites articulations : toutes autres articulations des membres</li>
      </ul>
