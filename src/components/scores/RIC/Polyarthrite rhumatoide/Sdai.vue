<template>
    <div>
        ...
        <p>L'interprétation de ce score compris entre 0 et 76 ne dépend pas de son évolution au cours du temps. Généralement, on considère qu'il y a rémission si le score est compris entre 0 et 3,3 inclus. Une activité faible est indiquée par un score > 3,3 jusqu'à 11 inclus. Une activité modérée est indiquée par un score compris entre > 11 et 26 inclus, tandis qu'une activité élevée est indiquée par un score strictement supérieur à 26.</p>
    </div>
