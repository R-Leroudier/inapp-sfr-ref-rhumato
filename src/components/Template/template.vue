<template>
  <div>
    ...
    <form class="form">
      ...
      <p class="details">
        On différencie les grosses et petites articulations :- Grosses
        articulations : épaule, coude, hanche, genou, cheville. - Petites
        articulations : toutes autres articulations des membres
      </p>
