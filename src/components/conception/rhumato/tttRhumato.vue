...
<span class="line"></span>
    ...
    <ul>
      <li>Corticoïdes 1 ou 2 mg/kg/jour (maximum 60 mg/jour) si PO</li>
      <li>Corticoïdes  IV 15-30 mg/kg, sans dépasser 1 gramme/jour pour 3 jours consécutifs si bolus</li>
      <li>Antagoniste du récepteur de l’IL-1</li>
      <li>Anticorps anti-récepteur de l’Il-6</li>
    </ul>
    ...
    <p>
      etanercept : 0,8 mg/kg/sem, maximum 50 mg
      <br>
      adalimumab : 24 mg/m2 de surface corporelle tous les 15 jours, maximum  20 mg  si 2 à 4 ans et maximum 40 mg si 4 à 12 ans
      <br>
    ...
    <p>- AINS utilisés :</p>
    <ul>
      <li>Indométacine : 2 - 3 mg/kg/jour en 2-3 prises p.o (dose maximale : 150 mg/jour) Hors AMM avant 15 ans</li>
      <li>Naproxène : 20 - 30 mg/kg/jour en 2 prises (dose maximale : 2 400 mg/jour) Hors AMM pour les doses préconisées</li>
      <li>Ibuprofène : 30-40 mg/kg/jour en 3-4 prises (dose maximale : 2 400 mg/jour)</li>
      <li>Diclofénac : 3 mg/kg/jour en 2 prises ( dose maximale : 150 mg/jour</li>
    </ul>
  </section>
</template>
